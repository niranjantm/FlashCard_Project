      ...
      <div className="flex flex-col flex-wrap  ">
        <div className="flex ">
          <div className="w-[]">
            <Link to={"/MyflashCards"} className="">
              <BsArrowLeft size={40} className="hover:bg-red-500/50 rounded-lg "></BsArrowLeft>
            </Link>
          </div>
        ...
        <div className="flex flex-row justify-evenly max-sm:flex max-sm:flex-col max-sm:items-center">
          ...
          <div className="relative max-w-xl  flex flex-wrap  rounded-lg gap-1 pb-3">
            <div className="flex max-w-full h-fit bg-stone-200 overflow-hidden border border-gray-600 rounded-lg scroll-smooth" ref={carouselRef}>
                  {deck[index].terms.map((item,i)=>{
                    return(
                      <div className={`  min-w-full flex flex-col justify-evenly items-center`}>
                        <img src={item.termImg} className="max-w-lg max-h-[200px] p-3 "></img>
                  ...
                  <div className="flex justify-around w-full">
                    <BiChevronLeft size={30} onClick={previous} className="border border-gray-400 rounded-lg bg-gray-400/25 hover:border-black"></BiChevronLeft>
                    
                    <BiChevronRight size={30} onClick={next} className="border border-gray-400 rounded-lg bg-gray-400/25 hover:border-black"></BiChevronRight>
                  </div>
